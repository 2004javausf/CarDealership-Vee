...
DOWN_PAYMENT NUMBER(*,2),
OFFER_STATUS VARCHAR2(10),
LOAN_AMOUNT NUMBER(*,2),
CAR_LOAN_ID NUMBER,
LOAN_MONTHS NUMBER);
...
CUSTOMER_ID INTEGER,
LOAN_AMOUNT NUMBER(*,2),
LOAN_INTEREST NUMBER(*,2),
LOAN_TOTAL_AMOUNT NUMBER(*,2),
LOAN_MONTHS INTEGER,
LOAN_MONTHLY_PAYMENT NUMBER(*,2),
LOAN_PAID NUMBER(*,2),
...
INSERT INTO CAR_LOAN (CAR_ID,CUSTOMER_ID,LOAN_AMOUNT,LOAN_INTEREST,LOAN_TOTAL_AMOUNT,LOAN_MONTHS,LOAN_MONTHLY_PAYMENT,LOAN_PAID,LOAN_PAYMENT_LEFT,LOAN_BALANCE)
VALUES (CARID,CUSTOMERID,LOANAMOUNT,RATE,TOTALLOAN,LOANMONTHS,MPAYMENTS,0.0,LOANMONTHS,TOTALLOAN);
...
DELETE FROM CAR_LOT WHERE CAR_ID=CARID;
